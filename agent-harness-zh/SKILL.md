...
description: >-
  ...
  pytest.ini、门禁脚本及 todo/PROGRESS/DECISIONS 全流程。适用于 Cursor、Codex、Claude Code、
  Skills CLI。用户说创建/初始化 harness、搭建协作目录时务必启用。English: agent-harness-en.
metadata:
  version: "1.0.0"
  repository: round-harness
  locale: zh-CN
  install-cli: "npx skills add HYX-LHJ/round-harness --skill agent-harness-zh -g -y"
---
...
安装路径：[references/installation.md](references/installation.md) · 英文 Skill：[../agent-harness-en](../agent-harness-en/) · 文档：[../docs/zh-CN/](../docs/zh-CN/)
...
**Skills CLI：** `npx skills add HYX-LHJ/round-harness --skill agent-harness-zh -g -y`
...
| [../agent-harness-en/SKILL.md](../agent-harness-en/SKILL.md) | 英文 Skill |
